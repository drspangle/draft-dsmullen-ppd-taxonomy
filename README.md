...
Use this repository for normative taxonomy text, local render workflow, and
local draft-only working notes for the taxonomy draft.
...
then bring the normalized taxonomy edit here.
